...
\label{fig:circuito_e_grafo}
	...
	\begin{minipage}{0.49\textwidth}
		...
		\includegraphics[width=\linewidth]{img/exemplo_circuito_simple.pdf}
		\legend{Desenho produzido pelo autor, baseado no circuito \textit{simple}, presente no \textit{benchmark} do \textit{contest} do ISPD 2012 \cite{ozdal2012ispd}.}
	\end{minipage}
	\hfill
	\begin{minipage}{0.49\textwidth}
		
		\caption{\label{fig:grafo_refinado}O grafo correspondente ao circuito apresentado na \autoref{fig:exemplo_circuito_simple}.}
		\includegraphics[width=\linewidth]{img/grafo_refinado.pdf}
		\legend{Desenho produzido pelo autor.}
	\end{minipage}
\end{figure}
...
\end{lstlisting}
\legend{Adaptada de uma biblioteca \textit{standard-cell} \cite{Contest2013}.}
